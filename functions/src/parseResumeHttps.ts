...
export const parseResumeToStructuredHistoryHttp = onRequest(
    {
        timeoutSeconds: 300, // 5 minutes timeout for parsing operations
        memory: '512MiB' // Increase memory for processing large documents
    },
